...
const addNewDrink = async(req,res)=>{
    try{
        ...
        return res.status(HTTP_STATUS.SERVER_ERROR).json({ mesagea : "Server Error "});
    }
}
...
const updateDrinkById = async(req,res)=>{
    try{
        ...
        return res.status(HTTP_STATUS.OK).json({ mesage : "Successfully updated !"});

    }catch(error){
        return res.status(HTTP_STATUS.SERVER_ERROR).json({ mesage : "Server Error "});
    }
}
...
const deleteDrinkById = async(req,res)=>{
    try{
        ...
        return res.status(HTTP_STATUS.OK).json({ mesage : "Successfully Deleted !"});
