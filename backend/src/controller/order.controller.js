...
const updateOrderById = async (req, res) => {
    try {
        ...
        if (!updatedOrder) return res.status(HTTP_STATUS.NOT_FOUND).json({ message: "Order Not Found!" });
...
const deleteOrderById = async (req, res) => {
    try {
        ...
        if (!deletedOrder) return res.status(HTTP_STATUS.NOT_FOUND).json({ message: "Order Not Found!" });
