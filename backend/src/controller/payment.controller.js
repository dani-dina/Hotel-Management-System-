...
const updatePaymentById = async (req, res) => {
    try {
        ...
        if (!updatedPayment) return res.status(HTTP_STATUS.NOT_FOUND).json({ message: "Payment Not Found!" });
...
const deletePaymentById = async (req, res) => {
    try {
        ...
        if (!deletedPayment) return res.status(HTTP_STATUS.NOT_FOUND).json({ message: "Payment Not Found!" });
