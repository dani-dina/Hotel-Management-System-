        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/admin/dashboard" className="flex-shrink-0 flex items-center">
              <img src={logo} alt="LUMINARA ADMIN" width={200} height={200} />
            </Link>
          </div>
            ...
            >
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d={toggleNavigation ? "M6 18L18 6M6 6l12 12" : "M4 6h16M4 12h16M4 18h16"}
                />
              </svg>
            </button>
          </div>
          ...
          <div className="pt-2 pb-3 space-y-1">
            {ADMIN_NAV_LINKS.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                onClick={() => setToggleNavigation(false)} // close on navigation
                className={`${
                  location.pathname === link.path
