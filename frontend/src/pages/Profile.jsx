      ...
      <div className="border-t border-gray-200 dark:border-gray-700 mt-4">
        <nav className="flex">
          ...
          <button
            ...
            className={`px-4 py-3 text-sm font-medium ${activeTab === 'media' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'}`}
          >
            Media
          </button>
          <button
            onClick={() => setActiveTab('likes')}
            className={`px-4 py-3 text-sm font-medium ${activeTab === 'likes' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'}`}
          >
            Likes
          </button>
        </nav>
