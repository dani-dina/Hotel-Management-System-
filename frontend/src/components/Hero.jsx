...
const Hero = () => {
  return (
    <div className='relative w-full h-[90vh] flex justify-center my-3'>
      <div
        className='relative w-[90%] h-[90%] bg-green-300 rounded-2xl bg-center bg-cover'
        style={{
      ...
      >
        ...
        <div
          className='absolute bottom-[-5%] left-1/2 transform -translate-x-1/2 w-[85%] h-[25%] rounded-2xl shadow-md
